package org.hbrs.se2.project.npng.views.layoutview;
...
import org.hbrs.se2.project.npng.views.UnternehmerProfilView;



public class UnternehmerLayoutView extends AppLayout {
    MenuBar menuBar = new MenuBar();


    public UnternehmerLayoutView(){
